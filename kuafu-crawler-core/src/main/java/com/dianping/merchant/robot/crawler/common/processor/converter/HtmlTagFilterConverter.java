...
public class HtmlTagFilterConverter implements ICrawlerConverter {

    private static final AvatarLogger LOGGER = AvatarLoggerFactory.getLogger(HtmlTagFilterConverter.class);
