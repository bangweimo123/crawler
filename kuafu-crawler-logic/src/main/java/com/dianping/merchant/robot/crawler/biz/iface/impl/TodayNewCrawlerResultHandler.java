...
import com.dianping.merchant.news.background.api.external.dto.CrawlerPageInfoContext;
import com.dianping.merchant.news.background.api.external.service.PageInfoExternalService;
...
public class TodayNewCrawlerResultHandler implements ICrawlerResultHandler {
    private static final AvatarLogger LOGGER = AvatarLoggerFactory.getLogger(TodayNewCrawlerResultHandler.class);
