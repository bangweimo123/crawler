...
public class LSSite extends Site {
    ...
    private LSProxyPool httpProxyPool;
     ...
     * @return this
     */
    public LSSite addCookie(String name, String value) {
     ...
     * @return
     */
    public LSSite addCookie(String domain, String name, String value) {
     ...
     * @return this
     */
    public LSSite setUserAgent(String userAgent) {
     ...
     * @return this
     */
    public LSSite setDomain(String domain) {
        this.domain = domain;
        return this;
    }
     ...
     * @return this
     */
    public LSSite setCharset(String charset) {
     ...
     * @param timeOut
     */
    public LSSite setTimeOut(int timeOut) {
     ...
     * @return this
     */
    public LSSite setAcceptStatCode(Set<Integer> acceptStatCode) {
     ...
     * @deprecated
     */
    public LSSite addStartUrl(String startUrl) {
     ...
     * @deprecated
     */
    public LSSite addStartRequest(Request startRequest) {
     ...
     * @return this
     */
    public LSSite setSleepTime(int sleepTime) {
     ...
     *
     * @param key   key of http header, there are some keys constant in {@link Site.HeaderConst}
     * @param value value of header
     * @return
     */
    public LSSite addHeader(String key, String value) {
     ...
     * @return this
     */
    public LSSite setRetryTimes(int retryTimes) {
     ...
     * @return this
     */
    public LSSite setCycleRetryTimes(int cycleRetryTimes) {
     ...
     * @return
     */
    public LSSite setHttpProxy(HttpHost httpProxy) {
     ...
     * @return
     */
    public LSSite setUseGzip(boolean useGzip) {
     ...
     * @return this
     */
    public LSSite setHttpProxyPool(List<String[]> httpProxyList, String proxyFile) {
        this.httpProxyPool = new LSProxyPool(httpProxyList, proxyFile);
        return this;
    }

    public LSSite setHttpProxyPool(String proxyFile) {
        this.httpProxyPool = new LSProxyPool(proxyFile);
        return this;
    }

    public LSProxyPool getHttpProxyPool() {
    ...
    public LSSite setProxyReuseInterval(int reuseInterval) {
